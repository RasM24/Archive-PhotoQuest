...
class PlaceDataSource(context: Context) {
	...
	private val hardcoreData = listOf(
		...
		Place("Площадь 1",
			  ...
			  92.88627617,
			  "point/c2/"),
		Place("Места 1", "КИЦ", AREA_CENTR, POINT_DIFF1, 56.010752, 92.894623, "point/c3/"),
		Place("Места 2",
			  "Почти KFC",
			  AREA_CENTR,
			  POINT_DIFF2,
			  ...
			  92.87620894,
			  "point/c4/"),
		Place("Дворы 2", "Дом", AREA_CENTR, POINT_DIFF4, 56.0148301, 92.88149703, "point/c5/"),
		Place("Дворы 3", "Дом", AREA_CENTR, POINT_DIFF4, 56.00965500, 92.88623530, "point/c6/"),
		Place("Места 3",
			  "Дворец им. Ярыгина",
			  AREA_CENTR,
			  POINT_DIFF3,
